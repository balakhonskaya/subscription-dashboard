...
import { subscriptionResolver } from './features/customers/pages/customer-details/subscription.resolver';
...
export const routes: Routes = [
  ...
  { path: 'customers', component: CustomerList },
  {
    ...
    resolve: { customer: customerResolver, subscriptions: subscriptionResolver },
  },
];
